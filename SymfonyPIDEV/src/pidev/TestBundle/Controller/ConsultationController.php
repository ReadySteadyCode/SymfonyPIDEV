...
use pidev\TestBundle\Entity\Consultation;
use pidev\TestBundle\Form\ConsultationType;
...
class ConsultationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestBundle:Consultation')->findAll();
     ...
     *
     * @Route("/", name="consultation_create")
     * @Method("POST")
     * @Template("TestBundle:Consultation:new.html.twig")
     */
    ...
    */
    private function createCreateForm(Consultation $entity)
    {
        $form = $this->createForm(new ConsultationType(), $entity, array(
            'action' => $this->generateUrl('consultation_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestBundle:Consultation')->find($id);
    ...
    /**
    * Creates a form to edit a Consultation entity.
    *
    * @param Consultation $entity The entity
    *
    * @return \Symfony\Component\Form\Form The form
    */
    private function createEditForm(Consultation $entity)
    {
        $form = $this->createForm(new ConsultationType(), $entity, array(
            'action' => $this->generateUrl('consultation_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="consultation_update")
     * @Method("PUT")
     * @Template("TestBundle:Consultation:edit.html.twig")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('consultation_delete', array('id' => $id)))
            ->setMethod('DELETE')
