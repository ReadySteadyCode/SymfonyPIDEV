...
use pidev\TestBundle\Entity\Rapport;
use pidev\TestBundle\Form\RapportType;
...
class RapportController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestBundle:Rapport')->findAll();
     ...
     * @Method("POST")
     * @Template("TestBundle:Rapport:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestBundle:Rapport')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TestBundle:Rapport:edit.html.twig")
     */
