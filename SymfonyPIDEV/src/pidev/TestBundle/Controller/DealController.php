...
use pidev\TestBundle\Entity\Deal;
use pidev\TestBundle\Form\DealType;
...
class DealController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestBundle:Deal')->findAll();
     ...
     * @Method("POST")
     * @Template("TestBundle:Deal:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestBundle:Deal')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TestBundle:Deal:edit.html.twig")
     */
