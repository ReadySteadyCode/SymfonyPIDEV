...
use pidev\TestBundle\Entity\Client;
use pidev\TestBundle\Form\ClientType;
...
class ClientController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestBundle:Client')->findAll();
     ...
     * @Method("POST")
     * @Template("TestBundle:Client:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestBundle:Client')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TestBundle:Client:edit.html.twig")
     */
