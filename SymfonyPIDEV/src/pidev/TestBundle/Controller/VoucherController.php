...
use pidev\TestBundle\Entity\Voucher;
use pidev\TestBundle\Form\VoucherType;
...
class VoucherController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestBundle:Voucher')->findAll();
     ...
     *
     * @Route("/", name="voucher_create")
     * @Method("POST")
     * @Template("TestBundle:Voucher:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestBundle:Voucher')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="voucher_update")
     * @Method("PUT")
     * @Template("TestBundle:Voucher:edit.html.twig")
     */
