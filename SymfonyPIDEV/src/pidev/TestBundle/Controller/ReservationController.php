...
use pidev\TestBundle\Entity\Reservation;
use pidev\TestBundle\Form\ReservationType;
...
class ReservationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestBundle:Reservation')->findAll();
     ...
     * @Method("POST")
     * @Template("TestBundle:Reservation:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestBundle:Reservation')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TestBundle:Reservation:edit.html.twig")
     */
