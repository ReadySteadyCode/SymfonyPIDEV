...
use pidev\TestBundle\Entity\Administrateur;
use pidev\TestBundle\Form\AdministrateurType;
...
class AdministrateurController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestBundle:Administrateur')->findAll();
     ...
     * @Method("POST")
     * @Template("TestBundle:Administrateur:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestBundle:Administrateur')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TestBundle:Administrateur:edit.html.twig")
     */
