...
use pidev\TestBundle\Entity\Message;
use pidev\TestBundle\Form\MessageType;
...
class MessageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TestBundle:Message')->findAll();
     ...
     * @Method("POST")
     * @Template("TestBundle:Message:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TestBundle:Message')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TestBundle:Message:edit.html.twig")
     */
